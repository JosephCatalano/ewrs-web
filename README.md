...
- Shared alert provider and host added under `src/shared/alerts`, wired through `AppProviders` and `App`, with target-aware rendering and text-only message output.
