...
2. Navigate to the **Book a Workspace** section.
3. Use the search filters to find available workspaces.
...
## How to remove a desk from favourites

1. In the search results, locate a desk marked with a filled **heart icon**.
2. Select the **heart icon** again to remove it from your favourites.

> **Tip:** You can save multiple favourite desks across different locations, floors, or time periods. They will always appear first when available for your searches.
